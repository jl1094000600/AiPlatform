...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'ai-output-governance', name: 'AiOutputGovernance', component: () => import('../views/AiOutputGovernance.vue') },
      { path: 'prompt-engineering', name: 'PromptEngineering', component: () => import('../views/PromptEngineering.vue') },

...
public class PromptEngineeringSchemaInitializer {
    ...
    public void initialize() {
        try (Connection connection = dataSource.getConnection();
            ...
            statement.executeUpdate("""
                    ...
                    """);
            addColumnIfMissing(connection, statement, "ai_agent_runtime_config", "prompt_id",
                    "ALTER TABLE ai_agent_runtime_config ADD COLUMN prompt_id BIGINT DEFAULT NULL");
            addColumnIfMissing(connection, statement, "ai_agent_runtime_config", "prompt_version_id",
                    "ALTER TABLE ai_agent_runtime_config ADD COLUMN prompt_version_id BIGINT DEFAULT NULL");
            addColumnIfMissing(connection, statement, "ai_agent_runtime_config", "system_prompt",
                    "ALTER TABLE ai_agent_runtime_config ADD COLUMN system_prompt MEDIUMTEXT DEFAULT NULL");
            addColumnIfMissing(connection, statement, "ai_agent_runtime_config", "user_prompt_template",
                    "ALTER TABLE ai_agent_runtime_config ADD COLUMN user_prompt_template MEDIUMTEXT DEFAULT NULL");
        } catch (SQLException e) {
            throw new IllegalStateException("Failed to initialize prompt engineering schema: " + e.getMessage(), e);
        }
    }

CREATE TABLE IF NOT EXISTS agent_run (
    ...
    memory_trace_id VARCHAR(96) DEFAULT NULL,
    max_steps INT NOT NULL DEFAULT 8,
    max_child_tasks INT NOT NULL DEFAULT 5,
    max_total_tokens INT NOT NULL DEFAULT 8000,
...
CREATE TABLE IF NOT EXISTS agent_step (
    ...
    tool_idempotency_key VARCHAR(128) DEFAULT NULL,
    input_json LONGTEXT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS agent_memory_snapshot (
    ...
    memory_version INT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS agent_run_execution_snapshot (
    ...
    is_deleted TINYINT NOT NULL DEFAULT 0,
    PRIMARY KEY (id),
    UNIQUE KEY uk_agent_run_execution_snapshot (run_id),
...
CREATE TABLE IF NOT EXISTS agent_run_event (
    ...
    is_deleted TINYINT NOT NULL DEFAULT 0,
    PRIMARY KEY (id),
    KEY idx_agent_run_event_run (tenant_id, run_id, create_time)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
